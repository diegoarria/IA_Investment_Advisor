...
import {
  ...
  GraduationCap, Upload, FileSpreadsheet, Plus,  Trash2, Trophy, Compass,
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden" style={{ background: "var(--bg)" }}>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* Main */}
        <main className="flex-1 overflow-y-auto scrollbar-thin p-4 space-y-5 max-w-3xl mx-auto w-full">
