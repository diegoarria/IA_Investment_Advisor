...
function DiscoverMorePanel({ candidates }: { candidates: DiscoverCandidate[] }) {
  ...
  return (
    <div className="mt-8">
      <p className="text-base font-bold pb-2 mb-4 border-b" style={{ color: "var(--text)", borderColor: "var(--border)" }}>
        {t("subvaluadas.backtest.discoverMore")}
      </p>
        ...
        {candidates.slice(0, 4).map((c) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-1.5 pt-2.5 border-t mb-2.5" style={{ borderColor: "var(--border)" }}>
              ...
              <div className="text-center text-[11px] font-bold rounded-lg px-2 py-1.5" style={{ background: bg, color: fg }}>
