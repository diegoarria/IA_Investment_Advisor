          ...
          return (
            <DiagRaisedBlock key={row.explKey} colors={colors} style={{ width: "47%" }}>
              <ExplainableValue
                ...
                colors={colors}
              >
                <Text style={{ fontSize: 10.5, fontWeight: "800", textTransform: "uppercase", color: colors.textMuted }}>{label}</Text>
              </ExplainableValue>
              <Text style={{ fontSize: 15, fontWeight: "900", color: colors.text, marginTop: 4 }}>{row.value}</Text>
