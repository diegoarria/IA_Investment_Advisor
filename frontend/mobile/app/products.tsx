...
const FREE_FEATURES = [
  ...
  "Portafolio de hasta 5 acciones",
...
const ONE_TIME = [
  ...
  },
  {
    ...
    desc: "Sesión privada de 45 min con un asesor financiero certificado. Revisan tu portafolio real, estrategia y dudas específicas.",
    priceFree: "$149 USD",
    pricePremium: "$99 USD",
    route: "/(tabs)/support",
  },
  {
    ...
    desc: "Tres sesiones 1:1 con asesor. Seguimiento mensual de portafolio, ajuste de estrategia y educación personalizada.",
