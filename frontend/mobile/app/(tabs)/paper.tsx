...
function makeStyles(c: Colors) {
  return StyleSheet.create({
    ...
    // Balance card
    balanceCard: { borderRadius: 16, borderWidth: 1, padding: 16, marginBottom: 12 },
    balanceRow: { flexDirection: "row", alignItems: "flex-start", marginBottom: 12 },
    balanceLabel: { fontSize: 11, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.4, marginBottom: 4 },
    balanceTotal: { fontSize: 30, fontWeight: "800", marginBottom: 6 },
    balanceReturnRow: { flexDirection: "row" },
    returnBadge: { flexDirection: "row", alignItems: "center", gap: 4, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
    returnBadgeText: { fontSize: 12, fontWeight: "700" },
    resetBtn: { flexDirection: "row", alignItems: "center", gap: 4, borderWidth: 1, borderColor: "rgba(239,68,68,0.4)", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 },
    resetBtnText: { color: "#ef4444", fontSize: 11, fontWeight: "600" },
    balanceSplit: { flexDirection: "row", borderTopWidth: 1, paddingTop: 12 },
    balanceSplitItem: { flex: 1, alignItems: "center" },
    balanceSplitLabel: { fontSize: 10, marginBottom: 3 },
    balanceSplitVal: { fontSize: 13, fontWeight: "700" },
    balanceSplitDivider: { width: 1, marginVertical: 2 },
    // Buy card
    buyCard: { borderRadius: 16, borderWidth: 1, padding: 14, marginBottom: 14 },
    searchBar: {
    ...
    tickerResultLeft: { flex: 1, gap: 2 },
    tickerSymbol: { fontSize: 20, fontWeight: "800" },
    tickerName: { fontSize: 12 },
    tickerResultRight: { alignItems: "flex-end", gap: 4 },
    tickerPrice: { fontSize: 20, fontWeight: "800" },
    tickerChangeBadge: { flexDirection: "row", alignItems: "center", gap: 3, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 3 },
    tickerChangePct: { fontSize: 12, fontWeight: "700" },
    buyForm: { flexDirection: "row", gap: 10, alignItems: "flex-end" },
    qtyWrap: { borderWidth: 1, borderRadius: 12, padding: 10, width: 110 },
    qtyLabel: { fontSize: 10, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.3, marginBottom: 2 },
    qtyInput: { fontSize: 20, fontWeight: "800", padding: 0 },
    totalCost: { fontSize: 12, marginBottom: 6 },
    buyBtn: { backgroundColor: "#22c55e", borderRadius: 12, paddingVertical: 13, alignItems: "center", justifyContent: "center" },
    buyBtnDisabled: { opacity: 0.4 },
    buyBtnText: { color: "white", fontWeight: "800", fontSize: 14 },
    // Sections
    sectionRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 10, marginTop: 4 },
    sectionTitle: { fontSize: 16, fontWeight: "700" },
    // Position card
    posCard: { borderRadius: 14, borderWidth: 1, padding: 14, marginBottom: 8 },
    posTop: { flexDirection: "row", alignItems: "flex-start", marginBottom: 10 },
    posTicker: { fontSize: 17, fontWeight: "800" },
    posName: { fontSize: 11, marginTop: 2 },
    posValue: { fontSize: 17, fontWeight: "700" },
    posChangeBadge: { flexDirection: "row", alignItems: "center", gap: 3, borderRadius: 6, paddingHorizontal: 6, paddingVertical: 3, marginTop: 3 },
    posChangePct: { fontSize: 12, fontWeight: "700" },
    posBottom: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderTopWidth: StyleSheet.hairlineWidth, paddingTop: 10 },
    posDetail: { fontSize: 11, flex: 1, marginRight: 10 },
    sellBtn: { borderWidth: 1, borderColor: "#ef4444", borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
    ...
    // History
    historyCard: { borderRadius: 14, borderWidth: 1, padding: 10 },
    tradeRow: {
      flexDirection: "row", alignItems: "center", gap: 10,
      paddingVertical: 10, borderBottomWidth: StyleSheet.hairlineWidth,
    },
    tradeBadge: { width: 26, height: 26, borderRadius: 7, alignItems: "center", justifyContent: "center" },
    tradeBadgeText: { fontSize: 11, fontWeight: "800" },
    tradeTicker: { fontSize: 14, fontWeight: "700" },
    tradeDetail: { fontSize: 11, marginTop: 1 },
    tradeTotal: { fontSize: 13, fontWeight: "700" },
    tradeDate: { fontSize: 10, marginTop: 2 },
    // TopUp modal
    topUpSheet: { borderTopLeftRadius: 24, borderTopRightRadius: 24, borderWidth: 1, padding: 24, paddingTop: 12 },
    topUpHandle: { width: 36, height: 4, borderRadius: 2, backgroundColor: "#374151", alignSelf: "center", marginBottom: 20 },
    topUpTitle: { fontSize: 20, fontWeight: "800", marginBottom: 6 },
    topUpSub: { fontSize: 13, marginBottom: 20 },
    planGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginBottom: 16 },
    planCard: { width: "47%", borderWidth: 1, borderRadius: 14, padding: 14, overflow: "hidden" },
    planTag: { alignSelf: "flex-start", borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2, marginBottom: 8 },
    planTagText: { color: "white", fontSize: 9, fontWeight: "800" },
    planAmount: { fontSize: 22, fontWeight: "800", marginBottom: 4 },
    planPrice: { fontSize: 14, fontWeight: "600" },
    topUpCloseBtn: { borderWidth: 1, borderRadius: 12, paddingVertical: 14, alignItems: "center" },
