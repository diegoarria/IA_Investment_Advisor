...
_WELCOME_COPY = {
    "es": {
        ...
        "trial_html": 'Tienes <strong style="color:#00d47e">30 días de Premium gratis</strong> incluidos en tu cuenta nueva. Úsalos para explorar todo sin límites.',
        "cta": "Empezar ahora →",
    ...
    "en": {
        ...
        "trial_html": 'You have <strong style="color:#00d47e">30 days of Premium free</strong> included in your new account. Use them to explore everything with no limits.',
        "cta": "Get started →",
