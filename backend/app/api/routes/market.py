                ...
                "content": [
                    ...
                    },
                    {
                        ...
                        "text": (
                            ...
                            "  REGLA 1 — Etiqueta explícita de compra:\n"
                            ...
                            "  REGLA 2 — Valor total + ganancia/pérdida (patrón más común en apps móviles):\n"
                            "    Muchas apps muestran por posición:\n"
                            "      • Un número grande = VALOR ACTUAL TOTAL de esa posición (shares × precio_actual)\n"
                            "      • Debajo en VERDE = ganancia en $ (ej. +$234.56 o $234.56 ↑)\n"
                            "      • Debajo en ROJO  = pérdida en $ (ej. -$34.56  o $34.56 ↓)\n"
                            "    En ese caso calcula:\n"
                            "      costo_total = valor_actual_total - ganancia_verde  (si hay ganancia)\n"
                            "      costo_total = valor_actual_total + abs(pérdida_roja) (si hay pérdida)\n"
                            "      avg_price   = costo_total / shares\n"
                            "    IMPORTANTE: el número grande NO es el avg_price, es el valor total.\n\n"
                            "  REGLA 3 — Monto invertido total:\n"
                            ...
                            "REGLAS GENERALES:\n"
                            "- NUNCA uses el precio actual de mercado como avg_price\n"
