...
_SHARE_MESSAGE = {
    "es": (
        "¡Hola! 👋 Te comparto Nuvos, una app que te ayuda a entender tu dinero y a tomar mejores decisiones al invertir, en lenguaje sencillo:\n\n"
        "📈 Ve tus inversiones en un solo lugar\n"
        "👀 Sigue las acciones que te interesan y recibe avisos cuando se mueven\n"
        "🧠 Arthur, un mentor con IA, te explica todo sin jerga\n"
        "💡 Mira el valor justo de una acción en 3 escenarios\n\n"
        "🎁 Si entras con mi enlace, te dan 14 días de Premium gratis:\n{link}\n\n"
        "(Nuvos es una herramienta educativa; no da recomendaciones de inversión.)"
    ),
    "en": (
        "Hi! 👋 I'm sharing Nuvos, an app that helps you understand your money and make better investing decisions, in plain language:\n\n"
        "📈 See your investments in one place\n"
        "👀 Follow the stocks you care about and get alerts when they move\n"
        "🧠 Arthur, an AI mentor, explains everything with no jargon\n"
        "💡 See a stock's fair value in 3 scenarios\n\n"
        "🎁 If you join with my link, you get 14 days of Premium free:\n{link}\n\n"
        "(Nuvos is an educational tool; it doesn't give investment recommendations.)"
    ),
}
