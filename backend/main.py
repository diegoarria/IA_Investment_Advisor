...
from app.api.routes import auth, profile, chat, market, notifications, screener, billing, learn, sync, paper, referral, support, earnings, simulate, decisions, watchlist, financials, brokerage, belvo, notification_settings, price_alerts, actions, upsells, wrapped, recap, push, feedback, profile_financial, library, voice_call, benchmark, admin, research, research_engine, investment_graph, explain, cash_holdings, dividends, checklist, weekly_rituals, morning_brief, smart_alerts, logo, telemetry
...
app.include_router(cash_holdings.router,    prefix="/api")
...
app.include_router(logo.router, prefix="/api")
