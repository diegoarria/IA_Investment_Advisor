-- Migration 043: add investment_graph_events to the atomic account-deletion
-- function (migration 035/040/041) now that migration 042 introduced the
-- table. Keep this in sync with _USER_DATA_TABLES in backend/app/api/routes/auth.py.
